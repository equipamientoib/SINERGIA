...
function cargarPortal(){
  ...
  css.rel='stylesheet'; css.href='css/13-clientes.css?v=93317b9c';
  document.head.appendChild(css);
  /* panel de expedientes (proyectos tipo "expediente"): sólo se carga con el portal,
     el resto del sitio no paga sus ~120 KB */
  const cssEx=document.createElement('link');
  cssEx.rel='stylesheet'; cssEx.href='css/15-expediente.css?v=93317b9c';
  document.head.appendChild(cssEx);
  ['js/06-expediente.js?v=93317b9c','js/06-tablero.js?v=93317b9c'].forEach(src=>{ const e=document.createElement('script'); e.src=src; e.async=false; document.head.appendChild(e); });

  const js=document.createElement('script');
  js.src='js/06-clientes.js?v=93317b9c'; js.async=false;      // async=false: se ejecuta después de los dos anteriores, en orden
  js.onload=()=>{
    PORTAL_ESTADO='listo';
